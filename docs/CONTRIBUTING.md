...
7. [Reviewing a Pull Request](#reviewing-a-pull-request)  
   7.1 [General guidelines](#general-guidelines)
   7.2 [How to review](#how-to-review)
...
3. Review the the code, commit by commit. 

<img src="./images/pr-commits.png" width="600">

4. Add comments and ask questions as you go along, if you have any.

<img src="./images/pr-comment.png" width="600">

5. Review the full set of changes.  
...
8. Merge the PR, if no changes or clarifications are required
